...
public class Books {
	...
	public Books(int b_id, String isbn, String b_password, String b_title, String b_author, int b_publicationYear) {
		super();
		this.b_id = b_id;
		this.isbn = isbn;
	...
	public String toString() {
		return "Books [b_id=" + b_id + ", isbn=" + isbn + ", b_password=" + b_password + ", b_title=" + b_title
				+ ", b_author=" + b_author + ", b_publicationYear=" + b_publicationYear + "]";
	}
